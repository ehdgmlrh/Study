...
function run()
{
   ...
   bigImage.setAttribute( "style", "width: 100ps; position: absolute; height: 30px; bottom: 101px; left: " +(count * 0.5 + "px") + ";" );
...
function display( imgfile )
{
   ...
   var bigImage = document.getElementById( "imgCover" );
   bigImage.setAttribute( "style", "width: 100px; height: 100px; bottom: 0; left: 0;" );
